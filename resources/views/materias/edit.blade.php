    ...
    <div style="width: 70%" class="mx-auto mt-4">
        <form method="POST" action="{{route('materias.update', $materia->id)}}">
            ...
            <div class="md:flex md:items-center mb-6">
              ...
              <div class="md:w-2/3">
                <input value="{{$materia->nombre}}" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="nombre" type="text"  placeholder="Ingrese el Nombre de la Materia"  name="nombre">
              </div>
            </div>
            <div class="md:flex md:items-center mb-6">
              <div class="md:w-1/3">
